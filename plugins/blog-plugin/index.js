...
async function blogPluginExtended(...pluginArgs) {
  const [context, options] = pluginArgs;

  // Example: Override the blog path and route
  const extendedOptions = {
    ...
    admonitions: {
      keywords: ['note', 'tip', 'info', 'warning', 'danger', 'quote'],
      extendDefaults: true,
    }
  };

  const blogPluginInstance = await defaultBlogPlugin(context, extendedOptions);
