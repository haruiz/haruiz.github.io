...
const ScholarIcon = () => {
    return (
        <svg fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px">
            <path
...
const SessionizeIcon = () => {
    return (
        <svg width="18px" height="18px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            <g id="Brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="Brand-Assets" transform="translate(-1216 -96)">
                    <g id="avatar" transform="translate(1200 80)">
                        <g id="brand/logo/sessionize-avatar-invert" transform="translate(16 16)">
                            <path d="M4 0h20c13.255 0 24 10.745 24 24v20a4 4 0 01-4 4H4a4 4 0 01-4-4V4a4 4 0 014-4z"
                                  id="inner-background" fill="black"/>
                            <path
...
export default function SocialLinks() {
    const social_links = [{
        ...
        {
            uri: "https://sessionize.com/henry-ruiz/",
            type: "custom",
            icon: <SessionizeIcon/>
        },
        {
    ...
    return social_links.map(({icon, type, uri}, index) => (
        <a href={uri} target="_blank" style={{margin: 10}} key={index}>{
            type === "custom" ? icon : <FontAwesomeIcon icon={icon} size="1x" color={"white"}/>
        }
        </a>
    ))
